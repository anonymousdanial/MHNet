...
def main():
	...
	print(cod10k.fuyo())
	train_image_dir = '/kaggle/working/dasatet/COD10K-v2/Train/Images/camo_images'
	train_mask_dir = '/kaggle/working/dasatet/COD10K-v2/Train/GT_Objects/GT_Object'
...
source_folder = "/kaggle/working/dasatet/COD10K-v2/Train/Images/Image"  # change to your source folder
target_folder = "/kaggle/working/dasatet/COD10K-v2/Train/Images/camo_images"  # new folder to store COD10K-CAM images
